...
const DATA := {
	...
	"pixel": {
		...
		"boss_name": "King Blob",
		"clear_bonus": 60,
		"intro": "Survive 6 rooms of blocky beasts (a couple are puzzles), then face King Blob.",
		"palette": {
	...
	"ascii": {
		...
		"clear_bonus": 120,
		"intro": "Letters with teeth. Survive 8 rooms, some of them puzzles, then face the Glyph Daemon.",
		"palette": {
	...
	"geometry": {
		...
		"clear_bonus": 200,
		"intro": "Nothing here is wasted, least of all its attacks. 10 rooms, then the Perfect Form.",
		"palette": {
